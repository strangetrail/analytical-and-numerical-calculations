...
#define k_dim_min           139
#define k_dim_max           154
#define k_dim_qa            146
...
#define k_radius_min        8
#define k_radius_max        8
#define k_radius_default    8
...
#define k_wavelength_min     380.0e-9
#define k_wavelength_max     720.0e-9
#define k_wavelength_default 633.0e-9

typedef float float3x3Tens_t[3][3];
